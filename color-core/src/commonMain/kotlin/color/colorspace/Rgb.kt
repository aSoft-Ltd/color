...
internal constructor(
     ...
     * @see getPrimaries
     */
    fun getPrimaries(primaries: FloatArray): FloatArray {
     ...
     * @see getInverseTransform
     */
    fun getTransform(transform: FloatArray): FloatArray {
    ...
    fun getInverseTransform(inverseTransform: FloatArray): FloatArray {
     ...
     * @see fromLinear
     */
    fun toLinear(v: FloatArray): FloatArray {
    ...
    fun fromLinear(v: FloatArray): FloatArray {
    ...
    internal companion object {
        ...
        internal fun xyWhitePoint(whitePoint: FloatArray): FloatArray {
