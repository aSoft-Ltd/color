 ...
 * `Color` supports [ColorSpace]s with 3 [components][ColorSpace.componentCount],
 * plus one for [alpha].
 *
 * ### Creating
 *
...
fun Color(color: Int) = Color(value = color.toULong() shl 32)
...
fun Color(color: Long) = Color(value = (color.toULong() and 0xffffffffUL) shl 32)
...
/**
 * If this [Color] [isUnspecified] then this is returned, otherwise [block] is executed and its result
 * is returned.
 */
